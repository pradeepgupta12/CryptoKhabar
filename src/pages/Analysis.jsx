...
function Analysis() {
  ...
  const articleListSchema = {
    ...
    "@type": "WebPage",
    "name": "Crypto Market Analysis - Crypto Khabar",
    "url": "https://cryptokhabar.net/analysis/",
    "description": "Explore in-depth cryptocurrency market analysis, trends, and sentiment insights for Bitcoin, Ethereum, DeFi, and more at Crypto Khabar.",
    "mainEntity": {
      "@type": "ItemList",
      "itemListElement": analysisData.articles.map((article, index) => ({
    ...
    <div className="page mt-20">
      ...
      <Helmet>
        ...
        <meta
          ...
          content="Explore in-depth cryptocurrency market analysis, trends, and sentiment insights for Bitcoin, Ethereum, DeFi, and more at Crypto Khabar."
        />
        <meta name="keywords" content="crypto market analysis, cryptocurrency, bitcoin, ethereum, defi, market trends, Crypto Khabar" />
        <meta name="author" content="Crypto Khabar Team" />
        <link rel="icon" href="/favicon.ico" />
        <link rel="canonical" href="https://cryptokhabar.net/analysis/" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Crypto Market Analysis - Crypto Khabar" />
        <meta property="og:description" content="Explore in-depth cryptocurrency market analysis, trends, and sentiment insights for Bitcoin, Ethereum, DeFi, and more at Crypto Khabar." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://cryptokhabar.net/analysis/" />
