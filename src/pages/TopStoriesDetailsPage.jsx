...
function TopStoriesDetailsPage() {
  ...
  const handleArticleClick = (article) => {
    ...
    navigate('/top-stories', { state: { article } });
  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 pt-12 p-4 mt-8">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="lg:col-span-2">
            <article className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative">
                ...
                {(article.section === 'partner' || article.section === 'press' || article.section === 'market') && (
                  <div className="absolute top-4 left-4">
                    <span className="bg-blue-600 text-white px-2 py-1 rounded text-xs font-medium">
                      {article.section === 'partner' ? 'PARTNER CONTENT' : article.section === 'press' ? 'PRESS RELEASE' : 'MARKETS'}
                    </span>
                  </div>
                )}
              </div>
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Similar Top Stories</h2>
            ...
            {topStories
              ...
              .map((story) => (
                <article
                  ...
                  onClick={() => handleArticleClick({ ...story, section: 'topStories' })}
                >
                  <img
...
export default TopStoriesDetailsPage;